...
const SiteB_ChienThan = ({ onHoverLink }) => {
  return (
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center">
        <div className="w-full max-w-5xl mx-auto mt-12 px-4 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 space-y-6 text-center md:text-left">
            <div className="inline-block px-4 py-1 rounded-full bg-orange-500/20 border border-orange-500/50 text-orange-300 text-sm font-semibold mb-2">
              GIẢI ĐẤU MÙA HÈ 2026
            </div>
            ...
            <p className="text-gray-300 text-lg mt-4 max-w-md">
              Tham gia chuỗi sự kiện đặc biệt, hoàn thành nhiệm vụ để nhận ngay rương trang phục Thần Thoại hoàn toàn miễn phí.
            </p>
        ...
        <div className="w-full max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-900/80 backdrop-blur border border-gray-800 p-6 rounded-xl hover:border-gray-600 transition-colors">
            ...
            <p className="text-gray-400 text-sm">Dùng Huy hiệu để đổi Skin Thần Thoại cực hiếm tại Cửa hàng sự kiện.</p>
          </div>
        </div>
      </main>
...
export default SiteB_ChienThan;
