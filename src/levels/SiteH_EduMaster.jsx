...
const SiteH_EduMaster = ({ onHoverLink }) => {
  return (
    <div className="min-h-full bg-gray-50 font-sans text-gray-800">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            <div className="text-2xl font-black text-teal-700 italic tracking-tighter">
              EduMaster<span className="text-emerald-500">.vn</span>
            </div>
            <div className="hidden md:flex relative w-80">
              <input 
                type="text" 
                placeholder="Tìm kiếm khóa học, giáo viên..." 
                className="w-full bg-gray-100 rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="hidden md:block text-sm font-semibold hover:text-teal-600 transition-colors">Kích hoạt khóa học</a>
            <button 
              onMouseEnter={() => onHoverLink('https://edumaster.vn/login')}
              onMouseLeave={() => onHoverLink('')}
              className="text-sm font-semibold border border-teal-600 text-teal-600 px-4 py-1.5 rounded-md hover:bg-teal-50 transition-colors"
            >
              Đăng nhập
            </button>
            <button 
              onMouseEnter={() => onHoverLink('https://edumaster.vn/register')}
              onMouseLeave={() => onHoverLink('')}
              className="text-sm font-bold bg-emerald-500 text-white px-4 py-1.5 rounded-md hover:bg-emerald-600 transition-colors shadow-sm"
            >
              Đăng ký
            </button>
          </div>
      ...
      {/* Hero Banner */}
      <div className="bg-teal-50 py-10 border-b border-teal-100">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 space-y-6">
            <div className="inline-block px-3 py-1 bg-emerald-100 text-emerald-700 font-bold text-sm rounded-full">HOT: ÔN THI TỐT NGHIỆP THPT 2026</div>
            <h1 className="text-4xl font-black text-gray-900 leading-tight">Giải pháp PRO 2026<br/>Luyện thi toàn diện</h1>
            ...
            <div className="flex gap-4 pt-2">
              <button 
                onMouseEnter={() => onHoverLink('https://edumaster.vn/khoa-hoc-truc-tuyen')}
                onMouseLeave={() => onHoverLink('')}
              ...
              <button className="bg-white border border-teal-200 text-teal-600 font-bold py-3 px-8 rounded-full hover:bg-teal-50 transition-colors">Tư vấn miễn phí</button>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <h2 className="text-2xl font-bold mb-8 border-l-4 border-teal-600 pl-4">Khóa học nổi bật</h2>
        <div className="grid md:grid-cols-4 gap-6">
          {[
            { 
              id: 1, 
              subject: "Môn Toán - Lớp 12", 
              title: "PRO-C: Ôn luyện toàn diện môn Toán 12 (Thầy Nguyễn Văn Hùng)", 
              img: "/math_course_cover.png" 
            },
            { 
              id: 2, 
              subject: "Ngữ Văn - Lớp 12", 
              title: "PRO-C: Bứt phá điểm 9+ Ngữ Văn THPT (Cô Trần Thị Thu Hà)", 
              img: "/literature_course_cover.png" 
            },
            { 
              id: 3, 
              subject: "Tiếng Anh - Lớp 12", 
              title: "PRO-M: Luyện giải đề Tiếng Anh chuyên sâu (Thầy Phạm Hoàng Nam)", 
              img: "/english_course_cover.png" 
            },
            { 
              id: 4, 
              subject: "Sinh Học - Lớp 12", 
              title: "PRO-I: Hệ thống kiến thức Sinh học cốt lõi (Cô Vũ Thanh Trúc)", 
            ...
            <div key={course.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden group cursor-pointer hover:shadow-md transition-shadow">
              ...
              <div className="p-4">
                <div className="text-xs text-teal-600 font-bold mb-1">{course.subject}</div>
                <h3 className="font-bold text-gray-800 mb-2 line-clamp-2 group-hover:text-teal-600 transition-colors">{course.title}</h3>
...
export default SiteH_EduMaster;
